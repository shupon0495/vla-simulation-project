...
def build_train_command(config: ExperimentConfig, preprocess_manifest: dict, run: Path) -> list[str]:
    ...
    return [
        'lerobot-train',
        f"--policy.path={preprocess_manifest['base_model_path']}",
        f"--policy.vlm_model_name={preprocess_manifest['vlm_path']}",
